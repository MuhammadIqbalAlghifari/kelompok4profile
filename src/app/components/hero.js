    ...
    return (
        <section className="w-full h-full">
            ...
            <main className="flex flex-col justify-center items-center">
                <div className="flex flex-col justify-center items-center px-12 h-screen">
                    <article className="flex flex-col justify-center items-center lg:gap-y-6 md:gap-y-4 gap-y-2.5">
                        ...
                        <div ref={el => {InputAnimation = el}} className="bg-gray-300 backdrop-blur-sm flex justify-center items-center bg-opacity-25 md:p-2 p-0.5 rounded-full">
                            <input className="bg-transparent md:placeholder:text-gray-300 placeholder:text-white border-none md:p-2 lg:text-base text-xs md:text-sm p-0.5" placeholder="Search furniture"/>
                            <FiSearch className="w-full h-full cursor-pointer text-white p-2.5 bg-orange-500 rounded-full"/>
                        </div>
                    </article>
                </div>
                <main className="lg:flex hidden justify-between items-start w-full h-[53vh] px-9">
